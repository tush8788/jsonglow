  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "jsonglow — JSON Formatter, Validator & Minifier" },
      {
        ...
        content:
          "Format, validate, minify and convert JSON to CSV instantly. Privacy-first: everything runs in your browser, nothing is uploaded.",
      },
    ...
    scripts: [
      // Google Analytics (GA4) — add this block
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-12DB2J3YP4",
        async: true,
      },
      {
        children: `
